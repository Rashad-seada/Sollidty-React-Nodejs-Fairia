const Card = (card) => {
  ...
  return (
    ...
    <div className="max-w-sm bg-secondary border-secondary border-solid border-4 rounded-lg mb-20">
     ...
     <div className="p-5">
         <a href="#">
             <h5 className="mb-2 text-2xl font-semibold tracking-tight text-sky-400 dark:text-white">Noteworthy technology acquisitions 2021</h5>
         </a>
         <p className="mb-3 font-normal text-gray-500 dark:text-gray-400">Here are the biggest enterprise technology acquisitions of 2021 so far, in reverse chronological order.</p>

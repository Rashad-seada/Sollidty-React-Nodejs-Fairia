            ...
            <div className="px-4 mx-auto sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16 lg:h-20">
                    <div className="flex-shrink-0">
                        ...
                        <a href="/" title="" className=" text-white text-4xl   transition-all duration-200 hover:text-opacity-80"> Faira </a>
                    ...
                    <div className="hidden lg:flex lg:items-center lg:justify-center lg:space-x-10">
                        <a href="/ExploreTender" title="" className="text-base text-white transition-all duration-200 hover:text-opacity-80"> Explore Tenders </a>

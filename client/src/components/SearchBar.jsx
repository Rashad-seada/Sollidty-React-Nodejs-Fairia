    ...
    <>
      ...
      <form className="max-w-md mx-auto bg-primary py-20">   
          ...
          <div className="relative">
              ...
              type="search" id="default-search" className="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-3xl bg-secondary focus:ring-blue-500 focus:border-blue-500 dark:bg-primary dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Mockups, Logos..." required />
              <button 
              onClick={()=>onsubmit()}
              type="submit" 

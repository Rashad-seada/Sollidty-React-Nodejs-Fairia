    ...
    <section class=" py-10 sm:py-16 lg:py-24">
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
                <div>
                    <p class="text-base font-semibold tracking-wider text-slate-400 uppercase">A social media for learners</p>
                    <h1 class="mt-4 text-4xl font-bold text-white lg:mt-8 sm:text-6xl xl:text-8xl">Select Your Contractor</h1>
                    <p class="mt-4 text-base text-white lg:mt-8 sm:text-xl">Chose who is the most qualified to do your tender.</p>

                    <a href="/ExploreTender" title="" class="inline-flex items-center px-6 py-4 mt-8 font-semibold text-black transition-all duration-200 bg-yellow-300 rounded-full lg:mt-16 hover:bg-yellow-400 focus:bg-yellow-400" role="button">
                        Explore Tenders
                ...
                <div>
                    <img class="w-full" src="https://i.pinimg.com/originals/ea/f3/31/eaf33183fd41bfca29b9427a7189a8a8.png" alt="" />
                </div>
            </div>
        </div>
    </section>

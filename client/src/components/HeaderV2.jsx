    ...
    <section className=" py-10 sm:py-16 lg:py-24">
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div className="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
                <div>
                    <p className="text-base font-semibold tracking-wider text-slate-400 uppercase">A social media for learners</p>
                    <h1 className="mt-4 text-4xl font-bold text-white lg:mt-8 sm:text-6xl xl:text-8xl">Select Your Contractor</h1>
                    <p className="mt-4 text-base text-white lg:mt-8 sm:text-xl">Chose who is the most qualified to do your tender.</p>

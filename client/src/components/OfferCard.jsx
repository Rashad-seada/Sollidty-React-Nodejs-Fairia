 ...
 <div className="flex min-h-screen items-center justify-center flex-wrap  ">
          <div className="relative flex max-w-[80%]  p-200 flex-row rounded-xl bg-secondary bg-clip-border text-gray-700 shadow-md">
            ...
            <div className="p-6">
              ...
              <p className="mb-8 block font-sans text-base font-normal leading-relaxed text-gray-50 antialiased">
                Like so many organizations these days, Autodesk is a company in
                transition. It was until recently a traditional boxed software
                company selling licenses. Yet its own business model disruption
                is only part of the story
              </p>
              <a className="flex justify-center pt-12" href="#">
                <Link
                  to={`/MyOffers`}
                  className="inline-flex items-center  px-3 py-2 text-sm font-medium text-center text-black bg-ter rounded-lg hover:bg-ter focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-ter dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                >
                  Read more
                  <svg

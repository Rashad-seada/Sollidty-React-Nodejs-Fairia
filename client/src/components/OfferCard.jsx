...
function OfferCard({title,description} ) {
 ...
 <div style={{fontSize:"80px"}}>
          <p className=" font-semibold flex justify-center text-cyan-50   py-36"> My<span className="text-sky-400 px-3">Offers</span> </p>
        </div>

 <div className="flex  items-center justify-center flex-wrap pb-14 ">
          <div 
          style={{height:"350px"}}
          className="relative flex max-w-[80%]  p-200 flex-row rounded-xl bg-secondary bg-clip-border text-gray-700 shadow-md">

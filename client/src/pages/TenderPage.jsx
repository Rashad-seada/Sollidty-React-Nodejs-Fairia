...
function TenderPage(
  ...
  return (
    ...
    <div className="min-w-screen min-h-screen bg-slate-950 flex items-center p-5 lg:p-10 overflow-hidden relative">
      <div className="w-full max-w-6xl rounded bg-slate-900 shadow-xl p-10 lg:p-20 mx-auto text-sky-400 relative md:text-left">
          ...
          <div className="w-full md:w-1/2 px-10">
            <div className="mb-10">
              ...
              <div className="inline-block align-bottom">
                <button className="bg-sky-700 opacity-75 hover:opacity-100 text-sky-50 hover:text-sky-50 rounded-full px-10 py-2 font-semibold">
